...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    public void setCollapse(boolean isCollapsed) {
    ...
    public void setText(final ExpandableTextView exTvDescDetail, String text) {
        ...
        mTv.post(new Runnable() {
            ...
            public void run() {
                ...
                if(lineCount >= 2)
                {
                    exTvDescDetail.setEnabled(true);
                }
                else
                {
                    exTvDescDetail.setEnabled(false);
                }
            }
        });
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mCollapseDrawable == null) {
            mCollapseDrawable = getDrawable(getContext(), R.drawable.arrow_up);
        }
    ...
    private void findViews() {
       ...
       // ColorFilter cf = new PorterDuffColorFilter(Color.rgb(222,222, 222), PorterDuff.Mode.OVERLAY);
        mButton.setImageDrawable(mCollapsed ? mExpandDrawable : mCollapseDrawable);

      //  mButton.setColorFilter(cf);
