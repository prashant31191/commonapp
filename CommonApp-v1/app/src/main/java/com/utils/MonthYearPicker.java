...
/**
 * Created by dhaval.mehta on 23-Feb-2017.
 */
...
public class MonthYearPicker {
    ...
    private static final String[] PICKER_DISPLAY_MONTHS_NAMES = new String[]{"January", "February", "March", "April", "May", "June", "July", "August", "September",
    ...
    public void build(int selectedMonth, int selectedYear, DialogInterface.OnClickListener positiveButtonListener,
        ...
        builder.setTitle("Month and Year");
